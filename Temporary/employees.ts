...
export const employees: Record<string, Employee> = {
  "ingvald-laiti": {
    ...
    timeline: [
      {
        year: "1989",
        title: "Grunnla Averdi",
        description: "Startet regnskapsbyrået i Karasjok med visjon om å betjene nordnorsk næringsliv",
        icon: "star",
        highlight: true
      },
      {
        year: "1995",
        title: "Statsautorisert regnskapsfører",
        description: "Oppnådde statsautorisasjon og utvidet tjenestetilbudet",
        icon: "graduation"
      },
      {
        year: "2005",
        title: "Spesialisering i samisk sektor",
        description: "Bygget unik kompetanse på regnskap for samiske organisasjoner og institusjoner",
        icon: "award"
      },
      {
        year: "2015",
        title: "Digital transformasjon",
        description: "Ledet overgangen til skybaserte løsninger med PowerOffice GO",
        icon: "briefcase"
      },
      {
        year: "2024",
        title: "30+ års erfaring",
        description: "Fortsetter å lede Averdi med fokus på kvalitet og lokal forankring",
        icon: "star",
        highlight: true
      }
    ]
